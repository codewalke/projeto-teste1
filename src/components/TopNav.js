    ...
    <div className ='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
       <div className='flex items-center'>
        <div onClick={()=> setSideNav(!sideNav)} className='cursor-pointer'>
            ...
            <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Delicious
                <apan className='font-bold'>Eats</apan>
            </h1>
       ...
       <button className='bg-orange-700 text-white hidden md:flex items-center py-2 rounded-full'>
        ...
        </button>
        {
          ...
          >
            ...
            />
            <h2 className='text-2xl p-4'>Delicious <span className='text-orange-700 font-bold'>Eats</span></h2>
            <nav>
