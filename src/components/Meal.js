    ...
    <div className='max-w-[1520px] m-auto px-4 py-12'>
        ...
        <div className='flex flex-col lg:flex-row justify-center'>
          <div className='flex justify-center md:justify-center py-2'>
            ...
            className='m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'>Chick </button>
            <button  
        ...
        <div className='grid md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-4 gap-6 py-4'> 
            {
                foods.map((item)=>(
                    <div key={item.id} className='border-none hover:scale-105 duration-300 py-2'>
                      <img src={item.image}
                      alt={item.name}
                      ...
                      <div className='pl-2 py-4 -mt-7'>
                          <p className='flex items text-indigo-600 '>View More < ArrowSmRightIcon className='w-5 ml-2'/></p>
                      </div>
                    </div>
                ) )
            }
